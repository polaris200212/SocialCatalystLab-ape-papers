# Initial Research Plan — paper_199 (Revision of apep_0489)
...
1. **Synthetic validation:** 8 DGPs with known treatment effects, 5 ablation studies (all passing as of apep_0489)
...
**Primary improvements over apep_0489 v1:**

1. **Deepen theoretical exposition:**
...
2. **Strengthen connection to structural economics:**
   - Frame heterogeneous effects in terms of career choice theory (Keane & Wolpin, Arcidiacono)
...
3. **Enhance methodological clarity:**
   - Clarify distinction between task vector arithmetic (Ilharco) and our causal application
...
4. **Expand heterogeneity analysis:**
   - By age cohort (young workers more mobile; old workers less affected)
   - By initial occupation (farmers vs. non-farm workers — TVA mainly industrial)
   - By race (historical discrimination constraints and opportunities)

5. **Refine policy interpretation:**
   - Quantify which occupations/industries benefited most from TVA
   - Assess distributional incidence: did benefits reach all workers or concentr ate?
   - Link to broader place-based policy literature (place premium, agglomeration)
