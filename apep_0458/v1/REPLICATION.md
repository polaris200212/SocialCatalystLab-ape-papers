...
- `density_test.csv`
- `event_study_rdd.csv`
- `hesta_municipal_raw.csv`
- `hesta_raw.csv`
- `rdd_cross_section.csv`
- `rdd_main_results.csv`
- `rdd_tourism_results.csv`
- `robustness_bandwidth.csv`
- `robustness_donut.csv`
- `robustness_jackknife.csv`
- `robustness_kernel.csv`
- `robustness_placebo.csv`
- `robustness_polynomial.csv`
- `statent_canton_noga_raw.csv`
- `statent_municipal_raw.csv`
- `statent_sector_raw.csv`
- `statent_total_raw.csv`
- `statpop_municipal_raw.csv`
- `statpop_raw.csv`
- `zwa_current.csv`
- `zwa_panel.csv`
