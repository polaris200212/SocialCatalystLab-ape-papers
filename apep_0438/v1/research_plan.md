...
- **Who is actually treated?** Citizens of Appenzell Ausserrhoden (AR), who lost their Landsgemeinde in April 1997. The treatment is the abolition of public show-of-hands cantonal voting.
- **Primary estimand population:** Municipalities on the AR side of the AR-AI border (20 municipalities, ~55,000 residents).
- **Control population:** Municipalities on the AI side of the AR-AI border (4-6 municipalities, ~16,000 residents) which retained the Landsgemeinde.
- **Placebo/comparison population:** Secondary border pairs (SG-AI, SG-GL, LU-OW, LU-NW) provide cross-sectional comparisons.
- **Design:** Difference-in-Discontinuities (DiDisc) — spatial RDD × temporal pre/post variation.
- **Indirect mechanism:** The treatment (cantonal institution abolition) is measured through federal referendum outcomes (always secret ballot). The hypothesized channel is institutional spillover onto political culture and social norms.
