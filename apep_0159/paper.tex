...
\title{Shining Light on Paychecks: \\ The Effects of Salary Transparency Laws on Wages and the Gender Pay Gap\footnote{This paper is a revision of APEP-0154. Key revisions from v4: (1) collapsed-cell wild cluster bootstrap and Fisher randomization inference to address small-cluster concern; (2) leave-one-treated-state-out sensitivity analysis; (3) HonestDiD sensitivity bounds for gender DDD specification; (4) composition/selection balance tests; (5) upper-distribution robustness and firm-size threshold heterogeneity; (6) strengthened discussion of gender-stratified event studies; (7) added 5 references.}}
