...
df <- read_csv("output/paper_80/data/analysis_panel.csv", show_col_types = FALSE)
...
saveRDS(cs_never, "output/paper_80/data/main_results.rds")

# Save event study coefficients
write_csv(es_coefs, "output/paper_80/data/event_study_coefs.csv")
...
write_csv(results_summary, "output/paper_80/data/main_results_summary.csv")
