...
robustness <- readRDS("output/paper_80/data/robustness_results.rds")
...
# Save
write_csv(table1, "output/paper_80/tables/table1_summary.csv")
...
write_csv(table1_latex, "output/paper_80/tables/table1_latex.csv")
...
write_csv(main_results_table, "output/paper_80/tables/table2_main_results.csv")
...
write_csv(het_table, "output/paper_80/tables/table3_heterogeneity.csv")
...
robustness_table <- read_csv("output/paper_80/data/robustness_summary.csv", show_col_types = FALSE) %>%
  mutate(
    `95% CI` = sprintf("[%.0f, %.0f]", CI_lower, CI_upper),
    sig = case_when(
      abs(t_stat) > 2.576 ~ "***",
...
write_csv(robustness_table, "output/paper_80/tables/table4_robustness.csv")
...
write_csv(es_table, "output/paper_80/tables/table5_event_study.csv")
...
write_csv(cohort_table, "output/paper_80/tables/table6_cohorts.csv")
...
cat("\n\nTables saved to output/paper_80/tables/\n")
