...
es_coefs <- read_csv("output/paper_84/data/event_study_coefs.csv", show_col_types = FALSE)
...
ggsave("output/paper_84/figures/fig1_adoption_map.pdf", fig1_map,
...
ggsave("output/paper_84/figures/fig2_cohort_trends.pdf", fig2_trends,
...
ggsave("output/paper_84/figures/fig3_event_study.pdf", fig3_event,
       width = 10, height = 6, dpi = 300)
...
ggsave("output/paper_84/figures/fig4_heterogeneity.pdf", fig4_het,
       width = 8, height = 6, dpi = 300)
...
robustness <- read_csv("output/paper_84/data/robustness_summary.csv", show_col_types = FALSE)
...
ggsave("output/paper_84/figures/fig5_robustness.pdf", fig5_robust,
       width = 10, height = 6, dpi = 300)
...
ggsave("output/paper_84/figures/fig6_timeline.pdf", fig6_timeline,
       width = 10, height = 6, dpi = 300)
...
ggsave("output/paper_84/figures/fig1_adoption_map.png", fig1_map, width = 8, height = 6, dpi = 150)
ggsave("output/paper_84/figures/fig2_cohort_trends.png", fig2_trends, width = 10, height = 6, dpi = 150)
ggsave("output/paper_84/figures/fig3_event_study.png", fig3_event, width = 10, height = 6, dpi = 150)
ggsave("output/paper_84/figures/fig4_heterogeneity.png", fig4_het, width = 8, height = 6, dpi = 150)
ggsave("output/paper_84/figures/fig5_robustness.png", fig5_robust, width = 10, height = 6, dpi = 150)
ggsave("output/paper_84/figures/fig6_timeline.png", fig6_timeline, width = 10, height = 6, dpi = 150)

cat("\nAll figures saved to output/paper_84/figures/\n")
