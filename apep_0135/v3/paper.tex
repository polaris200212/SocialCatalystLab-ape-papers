...
\title{Technological Obsolescence and Populist Voting: \\ Evidence from U.S. Metropolitan Areas\footnote{This paper is a revision of APEP-0137 (itself a revision of APEP-0135). See \url{https://github.com/SocialCatalystLab/auto-policy-evals/tree/main/papers/apep_0137} for the parent paper. This revision adds 2008 baseline controls, geographic maps, event-study analysis, population-weighted specifications, and industry robustness checks.}}
...
\begin{table}[H]
\centering
\caption{Robustness: Metropolitan vs. Micropolitan Areas}
\label{tab:app_metro}
\begin{threeparttable}
\begin{tabular}{lcc}
\hline\hline
