...
These findings contribute to a central debate in the economics of place-based policy: whether targeted federal investment can overcome the locational disadvantages of chronically poor areas, or whether such transfers merely slow the natural adjustment of workers to more productive locations.
...
To build the analysis sample, I start with the 4,600 county-year observations in the ARC panel and center the CIV at the year-specific Distressed threshold for each fiscal year (the midpoint between the highest CIV among At-Risk counties and the lowest CIV among Distressed counties). The centered running variable, $CIV^c_{it} = CIV_{it} - c_t$, is positive for Distressed counties and negative for At-Risk and lower-tier counties.
...
The primary threat to identification is \textbf{manipulation of the running variable}. If counties could strategically position themselves above or below the Distressed threshold, the continuity assumption would fail. Three features of the institutional setting address this concern. The CIV is computed from federally produced statistical series (BLS unemployment, BEA income, Census poverty) that are not subject to county-level manipulation. Moreover, the threshold is determined by the \textit{national} CIV distribution, which no individual county can influence. I formally test for manipulation using the density test of \citet{cattaneo2020simple}.
...
\cmidrule(lr){2-4} \cmidrule(lr){5-7}
 & Unemp.\ & Log & Poverty & Unemp.\ & Log & Poverty \\
 & Rate & PCMI & Rate & Rate & PCMI & Rate \\
\midrule
RD estimate & $-0.305$ & $-0.005$ & $0.505$ & $0.010$ & $0.012$ & $0.095$ \\
 & $(0.364)$ & $(0.026)$ & $(0.558)$ & $(0.227)$ & $(0.015)$ & $(0.423)$ \\
95\% CI & $[-1.02, 0.41]$ & $[-0.06, 0.05]$ & $[-0.59, 1.60]$ & $[-0.44, 0.46]$ & $[-0.02, 0.04]$ & $[-0.73, 0.93]$ \\[3pt]
Total obs.\ & 3,317 & 3,317 & 3,317 & 3,317 & 3,317 & 3,317 \\
Bandwidth ($h$) & 15.4 & 10.7 & 15.4 & 7.3 & 10.0 & 7.9 \\
Eff.\ obs.\ & 1,028 & 713 & 1,027 & 648 & 901 & 716 \\
