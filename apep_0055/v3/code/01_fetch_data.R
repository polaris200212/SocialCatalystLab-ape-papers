...
# We download 2016-2023 (8 years, all using 2003 certificate revision)
...
# MBSTATE_REC - Mother's birthplace state (1-4 recode)
#               1 = Born in state of residence
#               2 = Born in another state
#               3 = Born outside US
#               4 = Born in US, state unknown
#
