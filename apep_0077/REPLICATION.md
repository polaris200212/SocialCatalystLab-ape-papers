...
**Cached data files:**
- `analysis_eitc_crime.csv`
- `analysis_eitc_only.csv`
- `analysis_state_year.csv`
- `bacon_decomposition.csv`
- `cs_results.rds`
- `eitc_policy.csv`
- `eitc_state_year_panel.csv`
- `paid_leave_dates.csv`
- `pay_transparency_dates.csv`
- `shb_policy_dates.csv`
- `state_crime_corgis.csv`
- `state_quarter_panel.csv`
- `summary_stats.csv`
