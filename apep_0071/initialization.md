...
**Revision Rationale:** Fix identification issues (border-pair heterogeneity, inference with few clusters, balance tests, placebo outcomes) and strengthen climate policy motivation.
