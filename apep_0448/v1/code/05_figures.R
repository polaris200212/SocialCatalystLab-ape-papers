...
ri_dist <- data.table(coef = robust$ri_distribution)

p7 <- ggplot(ri_dist, aes(x = coef)) +
...
ggsave(file.path(FIGS, "fig7_randomization_inference.pdf"), p7, width = 7, height = 4.5)
