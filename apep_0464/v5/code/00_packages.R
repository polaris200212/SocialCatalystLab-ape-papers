## ============================================================================
## 00_packages.R — Connected Backlash (apep_0464 v4)
## Load all required packages for analysis
## v3: Add ShiftShareSE (AKM inference), insee (BDM API)
## v4: Add HonestDiD (Rambachan-Roth sensitivity analysis)
## ============================================================================
...
## — v3: Shift-share inference (AKM 2019)
load_pkg("ShiftShareSE")

## — v4: HonestDiD (Rambachan-Roth 2023)
load_pkg("HonestDiD")

## — Structural / Spatial estimation
load_pkg("maxLik")         # MLE
load_pkg("numDeriv")       # Numerical derivatives for Hessian
load_pkg("optimx")         # Optimization
load_pkg("spatialreg")     # SAR/SEM/SDM (v2: referee request)
load_pkg("spdep")          # Spatial neighbors and weights

## — Robust inference
## fwildclusterboot not available for R 4.5.2; manual WCB implemented in 04_robustness.R
