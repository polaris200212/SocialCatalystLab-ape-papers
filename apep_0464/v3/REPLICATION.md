...
**Cached data files:**
- `analysis_panel.rds`
- `carbon_tax_schedule.csv`
- `dept_controls.rds`
- `dept_panel.rds`
- `dept_results.rds`
- `distance_bin_data.rds`
- `elections_panel.rds`
- `event_study_data.rds`
- `event_study_results.rds`
- `fuel_vulnerability.rds`
- `main_results.rds`
- `migration_network.rds`
- `migration_weights.rds`
- `network_exposure.rds`
- `nuts3_dept_mapping.csv`
- `robustness_results.rds`
- `sci_dist.rds`
- `sci_matrix.rds`
- `sci_migration_correlation.rds`
- `structural_fit.rds`
- `structural_results.rds`
