...
# This script creates 'data/descriptive_stats.rds' which contains:
#   - overall: Overall sample summary statistics
#   - by_treatment: Summary by treatment status (pre-treatment period)
#   - by_gender: Summary by gender
#   - treatment_table: Treatment timing documentation
#
# Inputs:
#   - data/cps_analysis.rds (created by 02_clean_data.R)
#   - data/state_year_panel.rds (created by 02_clean_data.R)
#   - data/transparency_laws.rds (created by 00_policy_data.R)
#
# This file is consumed by:
#   - 07_tables.R (for Table 1 summary statistics)
...
cat("PROVENANCE: Created data/descriptive_stats.rds from 03_descriptives.R\n")
