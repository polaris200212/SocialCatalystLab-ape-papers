...
- `analysis_data.rds`
- `balance_results.rds`
- `balances_comptables_communes_2019.csv`
- `balances_comptables_communes_2020.csv`
- `balances_comptables_communes_2021.csv`
- `balances_comptables_communes_2022.csv`
- `bw_sensitivity.rds`
- `communes_france.csv`
- `density_test.rds`
- `mde_results.rds`
- `mht_correction.rds`
- `placebo_results.rds`
- `populations_legales.csv`
- `rd_first_stage.rds`
- `rd_results.rds`
- `rd_results_v2.rds`
- `rne_conseillers_municipaux.csv`
