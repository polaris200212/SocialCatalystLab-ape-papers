...
**Cached data files:**
- `acs_outcomes_2016_2020.csv`
- `balance_test.csv`
- `bandwidth_sensitivity.csv`
- `first_stage_result.csv`
- `fta_apportionments_raw.csv`
- `fta_funding_summary.csv`
- `fuzzy_rd_result.csv`
- `heterogeneity_transit.csv`
- `mccrary_test.csv`
- `ntd_uza_service.csv`
- `placebo_thresholds.csv`
- `power_analysis.csv`
- `rdd_results.csv`
- `ua_analysis.csv`
- `ua_analysis_sample.csv`
- `ua_analysis_with_fta.csv`
- `ua_analysis_with_ntd.csv`
- `ua_census_2010.csv`
- `ua_combined.csv`
- `ua_population_2020.csv`
...
- `00_packages.R`
- `01_fetch_data.R`
- `01b_fetch_fta_data.R`
- `01c_fetch_ntd_data.R`
- `02_fetch_ua_characteristics.R`
- `03_main_analysis.R`
- `04_figures.R`
