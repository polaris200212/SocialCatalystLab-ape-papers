...
# Get actual coefficient from main specification (2SLS estimate)
...
# 4c. Horse race (from main results, if available)
if ("tier3_horserace" %in% names(main_results)) {
  ...
  cat("  Horse race: Not available in current results\n")
}
...
se_state <- se(main_results$iv_2sls)[1]
