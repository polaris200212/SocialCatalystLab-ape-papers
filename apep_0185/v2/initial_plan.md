...
**Paper Type:** DESCRIPTIVE DATA PAPER (Pivoted from original causal design)

---

## Exposure Alignment (DESCRIPTIVE PAPER)

This paper is a DESCRIPTIVE DATA PAPER that constructs and characterizes a new measure. No causal effects are estimated.

**Who is treated:** N/A - This is a descriptive paper. We document the properties of a new network exposure measure.

**Primary estimand population:** All U.S. counties (3,068 counties). We describe variation in network minimum wage exposure.

**Placebo/control population:** N/A - No causal design employed.

**Design:** CONTINUOUS EXPOSURE DESIGN (NOT DiD). We use a shift-share-like framework where:
- "Shares" = Pre-determined SCI weights (2018 vintage, time-invariant)
- "Shifts" = Minimum wage changes in connected states

The analysis in Section 7 is labeled "ILLUSTRATIVE" and does NOT claim causal effects.

---

## ORIGINAL PLAN (SUPERSEDED)

The original plan below was superseded when the paper pivoted to a descriptive focus.
