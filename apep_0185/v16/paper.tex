...
\title{Friends in High Places: \\ Social Network Connections and Local Labor Market Outcomes\footnote{This paper is a revision of APEP-0211. See \url{https://github.com/SocialCatalystLab/ape-papers/tree/main/apep_0211} for the parent paper.}}
...
\begin{tablenotes}[flushleft]
\small
\item \textit{Notes:} Employment 2SLS coefficient is 0.826 for population-weighted and 0.323 for probability-weighted specifications. \textsuperscript{a}Anderson-Rubin confidence set for the population-weighted specification: [0.51, 1.13], following the weak-instrument-robust inference framework of \citet{andrews2019weak}. Permutation inference based on 2,000 random reassignments of exposure values within time periods; zero of 2,000 permuted coefficients exceed the actual coefficient for either weighting scheme. Network clustering uses SCI-based county groupings.
\end{tablenotes}
\end{threeparttable}
\end{table}
