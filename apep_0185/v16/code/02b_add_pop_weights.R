...
#
# Input files (produced by 01_fetch_data.R and 02_clean_data.R):
#   ../data/analysis_panel.rds   - Main county-year panel (02_clean_data.R)
#   ../data/raw_sci.rds          - Facebook SCI pairs (01_fetch_data.R)
#   ../data/raw_county_centroids.rds - County centroids (01_fetch_data.R)
#   ../data/state_mw_panel.rds   - State minimum wage panel (02_clean_data.R)
################################################################################
