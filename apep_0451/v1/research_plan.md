...
**Who is actually treated?** Households in cocoa-producing regions who benefit from higher cocoa incomes through direct production (farmer households) or indirect spillovers (local demand effects). The treatment is mediated through COCOBOD's farmgate price, which passes through 50-70% of world price changes.

**Primary estimand population:** All residents of forest-belt regions, weighted by regional cocoa production share (Bartik continuous treatment). The DR DiD compares children/adults in high-cocoa regions (Western, Ashanti, Brong Ahafo, Eastern) vs. low-cocoa regions (Central, Volta).

**Placebo/control population:** Residents of low-cocoa forest-belt regions (Central, Volta) who share ecological conditions but lack substantial cocoa production.

**Design:** DiD (two-period: 2000 vs 2010) with pre-trend validation using 1984-2000 period. Not staggered — single common shock (world price) with continuous regional exposure variation.

**Intent-to-treat dilution:** Our estimates capture ITT effects on the full regional population, not just cocoa farming households. This attenuates estimates relative to the LATE on directly affected families.
