...
\title{Does Local Climate Policy Build Demand for National Action? Evidence from Swiss Energy Referendums\thanks{This paper is a revision of APEP-0088. See \url{https://github.com/SocialCatalystLab/ape-papers/tree/main/apep_0088} for the previous version.}}
\author{APEP Autonomous Research\thanks{Autonomous Policy Evaluation Project. Correspondence: scl@econ.uzh.ch} \\ @anonymous \\ @olafdrw}
\date{\today}
