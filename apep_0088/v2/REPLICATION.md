...
**Cached data files:**
- `analysis_data.rds`
- `border_distances_corrected.rds`
- `border_pair_data.rds`
- `border_pairs_verified.rds`
- `canton_treatment.rds`
- `canton_treatment_verified.rds`
- `didisc_results.rds`
- `gemeinde_boundaries.rds`
- `gemeinde_spatial.rds`
- `key_results.rds`
- `panel_data.rds`
- `placebo_results_corrected.rds`
- `placebo_votes_raw.rds`
- `rd_results.rds`
- `rd_results_full.rds`
- `rdd_results_corrected.rds`
- `rdd_sample_corrected.rds`
- `treatment_verification.csv`
- `voting_data.rds`
- `voting_sf.rds`
...
- `08_revision_fixes.R`
- `09_fix_rdd_sample.R`
- `10_placebo_corrected.R`
- `11_didisc_analysis.R`
- `12_corrected_rdd_figures.R`
