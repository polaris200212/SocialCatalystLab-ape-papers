...
**Cached data files:**
- `absorption_rates.rds`
- `all_matched_exclusions.rds`
- `analysis_exclusions.rds`
- `anticipation_model.rds`
- `county_demographics.rds`
- `cs_did_models.rds`
- `event_study_models.rds`
- `heterogeneity_models.rds`
- `honestdid_results.rds`
- `leie_cleaned.rds`
- `leie_updated.csv`
- `npi_geography.rds`
- `placebo_model.rds`
- `randomization_inference.rds`
- `rom_panel.rds`
- `static_did_models.rds`
- `threshold_sensitivity.rds`
- `zip_county_xwalk.rds`
- `zip_month_panel.rds`
- `zip_svc_panel.rds`
