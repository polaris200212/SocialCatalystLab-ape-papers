...
- **Method:** DiD
- **Data era:** Modern
- **Risk appetite:** Novel policy (established data sources + understudied policy)
- **Other preferences:** None
- **API keys available:** FRED, College Scorecard, O*NET, OpenAI, Google (IPUMS and BEA not available)
