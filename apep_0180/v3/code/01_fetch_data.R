...
egger_ge_effects <- tibble::tribble(
  ...
  # Consumption expenditure (annualized, USD PPP)
  ...
  # Enterprise outcomes (for local businesses)
  "Enterprise revenue", 348, 89, 231, 72, 653
)

# Fiscal multiplier from Egger et al.
...
# Price effects (minimal inflation)
...
# Source: Haushofer & Shapiro (2018) working paper
# 3-year follow-up effects
