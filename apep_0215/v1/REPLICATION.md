...
- `main_results.rds`
- `panel_bfs.csv`
- `panel_construction.csv`
- `panel_healthcare.csv`
- `panel_information.csv`
- `panel_manufacturing.csv`
- `panel_software.csv`
- `panel_total.csv`
- `qcew_analysis.csv`
- `qcew_raw.csv`
- `reviewer_robustness.rds`
