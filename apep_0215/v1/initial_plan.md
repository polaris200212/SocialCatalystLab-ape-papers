...
**Who is treated:** All firms operating in a state with a comprehensive data privacy law. Treatment is state-level.

**Treatment-eligible population:** Technology-sector firms (NAICS 51), especially software publishers (NAICS 5112) who are most directly exposed to data privacy compliance requirements.

**Design:** Standard staggered DiD (not triple-diff/DDD).
