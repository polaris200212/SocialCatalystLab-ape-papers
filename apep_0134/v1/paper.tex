...
\small
\item Notes: Overdose death rates per 100,000 population. Pre-treatment period: 2015--2020 (6 years). Post-treatment period: 2022--2024 (3 years). 2021 excluded as partial treatment year. N (nhbd) = number of neighborhoods. Baseline donor pool excludes treated (2), adjacent (6), and low-rate (10) neighborhoods from 42 total NYC UHFs.
\end{tablenotes}
\end{threeparttable}
\label{tab:summary}
\end{table}
...
The synthetic control for East Harlem places positive weights on several donor neighborhoods with similar pre-treatment trajectories. The largest weights go to Hunts Point--Mott Haven (0.32), Crotona--Tremont (0.24), and Bedford--Stuyvesant (0.18). These neighborhoods share East Harlem's characteristics: high poverty rates, substantial homeless populations, and established drug markets. The pre-treatment fit is excellent, with actual and synthetic values tracking within 5 percent throughout 2015--2020 (the full pre-treatment period).
