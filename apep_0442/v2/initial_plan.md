...
**Exposure Alignment:**
- **Who is treated:** Union veterans reaching age 62 (automatic pension eligibility).
- **Primary estimand population:** Union veterans within bandwidth of age 62.
- **Control population:** Confederate veterans at same ages (no federal pension).
- **Estimand:** ITT effect of crossing eligibility threshold on labor supply.
