...
# Directories
dir_data <- here::here("output/paper_109/data")
dir_data_raw <- here::here("output/paper_109/data/fars_raw")
dir_data_osm <- here::here("output/paper_109/data/osm_roads")
dir_data_policy <- here::here("output/paper_109/data/policy")
dir_figs <- here::here("output/paper_109/figures")
dir_tabs <- here::here("output/paper_109/tables")
