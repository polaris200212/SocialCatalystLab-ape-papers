...
\begin{tablenotes}
\small
\item \textit{Notes:} Standard deviations in parentheses. Per-capita residential electricity consumption measured in Billion Btu per person. Prices in cents per kilowatt-hour. EERS States are the 28 jurisdictions (27 states plus DC) with mandatory Energy Efficiency Resource Standards; Non-EERS states are the 23 states that never adopted mandatory EERS. Pre-treatment sample restricts EERS states to years before their adoption year. Non-EERS states are shown for their full sample in the Pre-Treatment column because they serve as a never-treated comparison group throughout the study period; they have no treatment date, so the same observations are used as comparisons for all treated cohorts in the CS-DiD framework.
\end{tablenotes}
\end{table}
