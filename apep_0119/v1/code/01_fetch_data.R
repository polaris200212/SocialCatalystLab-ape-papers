...
# Sources: ACEEE State Database, DSIRE, NCSL
# Hand-coded from verified sources
###############################################################################
...
# Source: U.S. Census Bureau, 1990 Decennial Census (SF1)
# These are official counts; the Census API does not reliably serve 1990 data.
###############################################################################
