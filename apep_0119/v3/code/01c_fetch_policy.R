###############################################################################
# 01c_fetch_policy.R
# Paper 141: EERS Revision - Construct Policy Control Variables
...
# DATA PROVENANCE:
#   Primary sources:
#     - DSIRE Policy Database: https://www.dsireusa.org/resources/detailed-summary-maps/
#     - NCSL RPS Summary: https://www.ncsl.org/energy/state-renewable-portfolio-standards-and-goals
...
#   Note: Iowa's 1983 Alternative Energy Production standard is the earliest.
###############################################################################
...
# DATA PROVENANCE:
#   Primary sources:
#     - ACEEE State Policy Tracker: https://database.aceee.org/
#     - RAP (Regulatory Assistance Project): https://www.raponline.org/knowledge-center/
#   Access date: 2026-01-27
#   Raw source file: data/raw/aceee_decoupling.csv
#   Validation: Run 01d_validate_provenance.R to verify against source file
#
# METHODOLOGY:
#   Treatment definition: First year electric decoupling mechanism approved.
#   Note: California 1982 is earliest; many states updated mechanisms over time.
###############################################################################
...
# DATA PROVENANCE:
#   Primary sources:
#     - DOE Building Energy Codes Program: https://www.energycodes.gov/status
#     - ICC (International Code Council): https://www.iccsafe.org/products-and-services/i-codes/iecc/
#   Access date: 2026-01-27
#   Raw source file: data/raw/doe_building_codes.csv
#   Validation: Run 01d_validate_provenance.R to verify against source file
#
# METHODOLOGY:
#   Treatment definition: First adoption of IECC 2009 or equivalent/stricter state code.
#   IECC 2009 represents significant efficiency improvement over prior codes.
#   State-specific codes (California Title 24, Florida Energy Code) coded at
#   equivalent stringency year.
###############################################################################
...
#
# DATA PROVENANCE:
#   Source: U.S. Census Bureau Standard Geographic Definitions
#   URL: https://www.census.gov/programs-surveys/economic-census/guidance-geographies/levels.html
#   Reference map: https://www2.census.gov/geo/pdfs/maps-data/maps/reference/us_regdiv.pdf
#
# NOTES:
#   - 9 Census Divisions within 4 Census Regions
#   - Definitions are stable and standardized by Census Bureau
#   - Assignments verified against official Census Bureau definitions
###############################################################################
