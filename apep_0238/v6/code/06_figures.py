"""
06_figures.py — Generate all figures for apep_0238 v6
"""
...
rescale_factor = bartik_sd_fig10 / hpi_sd_fig10  # Computed from data
...
ax.set_xlabel('Negated Saiz supply elasticity (higher = more constrained)', fontsize=12)
