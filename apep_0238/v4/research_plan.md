...
**Who is treated:** All workers and firms in states with greater pre-recession exposure to the relevant shock. For the Great Recession, exposure is measured by the 2003--2006 housing price boom (continuous treatment intensity). For COVID, exposure is the Bartik-predicted employment shock from pre-pandemic industry composition.

**Affected population:** The entire state labor market---employment, unemployment, and labor force participation---is the outcome of interest. The design does not require a binary treated/control split; instead, it exploits continuous cross-state variation in recession exposure intensity.

**Comparison group:** States with lower exposure serve as implicit controls. The cross-sectional LP framework compares employment dynamics across the full distribution of exposure, not a discrete treatment/control classification.
