...
- `census_2001_pca.csv`
- `census_2011_pca.csv`
- `district_phase_assignment.csv`
- `district_year_panel.csv`
- `dmsp_nightlights.csv`
- `panel_dmsp_only.csv`
- `panel_viirs_only.csv`
- `viirs_nightlights.csv`
- `village_district_key.csv`
