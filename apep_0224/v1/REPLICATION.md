...
- `cdc_mortality_state_year.csv`
- `census_population_state_year.csv`
- `event_study_cs.csv`
- `event_study_cs_log.csv`
- `event_study_cs_nevertreated.csv`
- `event_study_placebo_cancer.csv`
- `event_study_placebo_heart.csv`
- `leave_one_cohort_out.csv`
- `main_results.csv`
- `medicaid_expansion.csv`
