...
- `commune_means.csv`
- `commune_population_panel.csv`
- `donut_tests.csv`
- `mccrary_tests.csv`
- `placebo_tests.csv`
- `polynomial_sensitivity.csv`
- `post2020_rdd.csv`
- `rdd_results.csv`
- `regression_models.RData`
- `robustness_results.RData`
- `sirene_creations.csv`
- `sirene_creations_interim.csv`
- `sirene_stock.csv`
- `switchers_analysis.csv`
