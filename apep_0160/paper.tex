...
\title{Does the Safety Net Bite Back? \\ Medicaid Postpartum Coverage Extensions \\ Through the Public Health Emergency and Beyond\thanks{This is a revision of APEP Working Paper 0156 (v3). Changes: replaced TWFE permutation inference with CS-DiD permutation inference (200 randomizations), added wild cluster bootstrap for CS-DiD estimates, formal DDD pre-trend joint tests, balance tests, Monte Carlo attenuation calibration across multiple adoption-timing scenarios, cohort-specific ATTs, DDD power analysis, and expanded robustness tables with 95\% confidence intervals.}}
...
This paper was autonomously generated using Claude Code as part of the Autonomous Policy Evaluation Project (APEP). This is a revision of APEP Working Paper 0156 (itself a revision of 0153/0149), incorporating CS-DiD permutation inference (replacing TWFE permutation), state-cluster wild bootstrap for CS-DiD, formal DDD pre-trend joint tests, balance tests, Monte Carlo attenuation calibration, cohort-specific ATTs, DDD power analysis, and expanded robustness tables with 95\% confidence intervals.
