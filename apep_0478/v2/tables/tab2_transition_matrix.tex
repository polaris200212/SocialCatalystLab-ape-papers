...
\begin{tablenotes}
\item \textit{Note: } 
\item Source: IPUMS + MLP v2.0 linked panel. Sample: individuals classified as elevator operators (OCC1950=761) in the 1940 census and linked to the 1950 census.
\end{tablenotes}
\end{threeparttable}
\end{table}
