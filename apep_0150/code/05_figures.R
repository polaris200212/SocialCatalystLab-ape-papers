...
if (file.exists("data/cs_event_study.rds")) {
  ...
  cat("  Event study results not found — skipping Figure 3\n")
  cat("  Run 03_main_analysis.R first\n")
}
...
if (file.exists("data/bacon_decomposition.rds")) {
  ...
  cat("  Bacon decomposition results not found — skipping Figure 4\n")
  cat("  Run 04_robustness.R first\n")
}
...
if (length(placebo_panels) > 0) {
  ...
  cat("  Placebo event study results not found — skipping Figure 5\n")
  cat("  Run 04_robustness.R first\n")
}
...
if (file.exists("data/honestdid_results.rds")) {
  ...
  cat("  HonestDiD results not found — skipping Figure 6\n")
  cat("  Run 04_robustness.R first\n")
}
