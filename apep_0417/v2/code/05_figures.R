...
## Changes from v1: Split desert maps into 3 paired figures,
## add MD/DO vs all-clinicians comparison, move unwinding map
## to Fig 3, fix y-axes, update to 6 specialties
## ============================================================
...
# Function to create a single desert map
make_desert_map <- function(data, spec_name, show_legend = FALSE) {
...
# ============================================================
# Figure 3: Unwinding Intensity Map (moved from §8 to §3)
# ============================================================
...
# ============================================================
# Figure 4: Primary Care + Dental desert maps (paired)
# ============================================================
cat("\n--- Figure 4: Primary Care + Dental maps ---\n")

p_pc <- make_desert_map(desert_2023, "Primary Care")
p_dental <- make_desert_map(desert_2023, "Dental", show_legend = TRUE)

fig4 <- p_pc / p_dental +
  plot_annotation(
    title = "Medicaid Provider Deserts: Primary Care and Dental, 2023Q1",
    subtitle = "All clinicians (MD/DO + NP/PA) per 10,000 county population",
    theme = theme(plot.title = element_text(face = "bold", size = 13))
  )

ggsave(file.path(FIG_DIR, "fig4_desert_pc_dental.pdf"), fig4,
       width = 8, height = 9)
cat("  Saved fig4_desert_pc_dental.pdf\n")

# ============================================================
# Figure 5: Psychiatry + Behavioral Health desert maps (paired)
# ============================================================
cat("\n--- Figure 5: Psychiatry + Behavioral Health maps ---\n")

p_psych <- make_desert_map(desert_2023, "Psychiatry")
p_bh <- make_desert_map(desert_2023, "Behavioral Health", show_legend = TRUE)

fig5 <- p_psych / p_bh +
  plot_annotation(
    title = "Medicaid Provider Deserts: Mental Health Specialties, 2023Q1",
    subtitle = "All clinicians (MD/DO + Psych NP) per 10,000 county population",
    theme = theme(plot.title = element_text(face = "bold", size = 13))
  )

ggsave(file.path(FIG_DIR, "fig5_desert_mental_health.pdf"), fig5,
       width = 8, height = 9)
cat("  Saved fig5_desert_mental_health.pdf\n")

# ============================================================
# Figure 6: OB-GYN + Surgery desert maps (paired)
# ============================================================
cat("\n--- Figure 6: OB-GYN + Surgery maps ---\n")

p_obgyn <- make_desert_map(desert_2023, "OB-GYN")
p_surg <- make_desert_map(desert_2023, "Surgery", show_legend = TRUE)

fig6 <- p_obgyn / p_surg +
  plot_annotation(
    title = "Medicaid Provider Deserts: Specialist Care, 2023Q1",
    subtitle = "All clinicians (MD/DO + Women's Health NP / Surgical PA) per 10,000 county population",
    theme = theme(plot.title = element_text(face = "bold", size = 13))
  )

ggsave(file.path(FIG_DIR, "fig6_desert_specialist.pdf"), fig6,
       width = 8, height = 9)
cat("  Saved fig6_desert_specialist.pdf\n")

# ============================================================
# Figure 7: MD/DO-only vs All Clinicians (Primary Care)
# ============================================================
cat("\n--- Figure 7: MD/DO vs All Clinicians comparison ---\n")
...
p_pc_mdonly <- make_desert_map(desert_2023_mdonly, "Primary Care") +
  labs(title = "Primary Care: MD/DO Only")
p_pc_all <- make_desert_map(desert_2023, "Primary Care", show_legend = TRUE) +
  labs(title = "Primary Care: All Clinicians (incl. NPs)")

fig7 <- p_pc_mdonly / p_pc_all +
  plot_annotation(
    title = "Impact of Including Nurse Practitioners: Primary Care Deserts, 2023Q1",
    subtitle = "Top: physicians only (v1 measure). Bottom: all clinicians including NPs (v2 measure).",
    theme = theme(plot.title = element_text(face = "bold", size = 12))
  )

ggsave(file.path(FIG_DIR, "fig7_md_vs_all_comparison.pdf"), fig7,
       width = 8, height = 9)
cat("  Saved fig7_md_vs_all_comparison.pdf\n")

# ============================================================
# Figure 8: Urban vs Rural Desert Share Over Time
# ============================================================
cat("\n--- Figure 8: Urban vs rural deserts ---\n")
...
fig8 <- ggplot(desert_trend[specialty %in% c("Primary Care", "Psychiatry",
...
ggsave(file.path(FIG_DIR, "fig8_urban_rural_deserts.pdf"), fig8,
       width = 9, height = 6)
cat("  Saved fig8_urban_rural_deserts.pdf\n")

# ============================================================
# Figure 9: Event Study — Pooled
# ============================================================
...
fig9 <- ggplot(es_coefs, aes(x = rel_q, y = estimate)) +
...
ggsave(file.path(FIG_DIR, "fig9_event_study.pdf"), fig9,
       width = 8, height = 5)
cat("  Saved fig9_event_study.pdf\n")

# ============================================================
# Figure 10: Permutation Inference Distribution
# ============================================================
cat("\n--- Figure 10: RI distribution ---\n")

ri_dist <- data.table(coef = robustness$ri_distribution)

fig10 <- ggplot(ri_dist, aes(x = coef)) +
...
ggsave(file.path(FIG_DIR, "fig10_ri_distribution.pdf"), fig10,
       width = 7, height = 4.5)
cat("  Saved fig10_ri_distribution.pdf\n")
