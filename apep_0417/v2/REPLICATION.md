...
**Cached data files:**
- `analysis_panel.rds`
- `analysis_panel_mdonly.rds`
- `county_population.rds`
- `county_shapes.rds`
- `county_specialty_quarter.rds`
- `county_specialty_quarter_mdonly.rds`
- `main_results.rds`
- `npi_lookup.rds`
- `npi_lookup_mdonly.rds`
- `provider_quarters.rds`
- `robustness_results.rds`
- `rucc.rds`
- `unwinding_treatment.rds`
- `zcta_county_xwalk.csv`
- `zcta_county_xwalk.json`
