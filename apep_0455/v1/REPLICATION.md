...
- `main_results.rds`
- `matched_commune_ids.rds`
- `matched_results.rds`
- `panel_commune_year.parquet`
- `panel_commune_year.rds`
- `panel_transactions.parquet`
- `panel_transactions.rds`
- `ri_results.rds`
- `robustness_results.rds`
- `summary_statistics.rds`
- `tlv_communes_pre2023.csv`
- `treatment.rds`
- `zonage_tlv_2025.csv`
- `zones_tendues_national.csv`
