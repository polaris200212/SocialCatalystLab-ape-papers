...
**Cached data files:**
- `alt_htm_results.rds`
- `asymmetry_results.rds`
- `bea_transfers.rds`
- `brw_shocks.rds`
- `exclude_extreme_results.rds`
- `fed_funds_rate.rds`
- `fiscal_results.rds`
- `horse_race_results.rds`
- `lp_baseline.rds`
- `main_results.rds`
- `panel_annual.rds`
- `panel_monthly.rds`
- `permutation_results.rds`
- `state_employment.rds`
- `state_gdp.rds`
- `state_homeownership.rds`
- `state_info.rds`
- `state_population.rds`
- `state_poverty.rds`
- `state_snap.rds`
- `subperiod_results.rds`
- `tercile_irf.rds`
