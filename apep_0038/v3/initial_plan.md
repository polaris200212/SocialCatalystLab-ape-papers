# Initial Research Plan — Revision of APEP-0038
...
1. **Data fetch:** Pull real BLS QCEW data via API for all states, 2012-2024
2. **Panel construction:** Build balanced state-quarter panel with treatment indicators
3. **Primary analysis:** Run CS DiD, generate event-study plots
4. **Robustness:** Full battery of sensitivity checks
5. **New analyses:** Wage DiD and spillover regression
6. **Paper writing:** Update all results, tables, figures; honest reporting of findings
7. **Review:** Full advisor + exhibit + prose + external review pipeline
