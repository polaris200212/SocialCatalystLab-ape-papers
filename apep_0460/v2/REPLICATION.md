...
- `analysis_panel.rds`
- `dept_exposure.rds`
- `dvf_dept_quarter.rds`
- `dvf_region_quarter.rds`
- `gadm2_dept_mapping.csv`
- `insee_firms_region.rds`
- `insee_unemployment_region.rds`
- `region_names.rds`
- `revision2_results.rds`
- `sci_france_germany.rds`
- `sci_france_switzerland.rds`
- `sci_france_uk.rds`
