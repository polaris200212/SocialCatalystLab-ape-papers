...
**Exposure and affected population:** All buildings with GFA >= 25,000 sq ft are treatment-eligible. The treatment is building-level (not individual-level), so the affected population is building owners and prospective buyers of above-threshold properties.
