...
- `census_panel.rds`
- `dist_key.rds`
- `district_baseline_phases.rds`
- `main_results.rds`
- `nightlights_village_year.rds`
- `nl_district_panel.rds`
- `pc01_village.rds`
- `pc11_village.rds`
- `robustness_results.rds`
- `viirs_district_panel.rds`
- `viirs_district_year.rds`
