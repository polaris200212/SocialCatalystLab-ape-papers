...
# INPUTS:
#   data/transparency_laws.rds     <- 00_policy_data.R (loaded if exists)
# OUTPUTS:
#   (none -- shared dependency, defines packages, theme, helper functions)
# SOURCED BY: all scripts 01-07
# ============================================================================
...
# ---- Synthetic DiD ----
# Arkhangelsky et al. (2021) - alternative estimator
if (requireNamespace("synthdid", quietly = TRUE)) {
  library(synthdid)
  cat("synthdid loaded for synthetic difference-in-differences.\n")
} else {
  cat("WARNING: synthdid not available. Install with: remotes::install_github('synth-inference/synthdid')\n")
}
