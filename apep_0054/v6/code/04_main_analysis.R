...
# OUTPUTS:
#   data/cs_main_result.rds        (Callaway-Sant'Anna group-time ATTs)
#   data/event_study_data.rds      (event study coefficients for plotting)
#   data/main_results.rds          (all main results: CS-DiD, TWFE, DDD, bargaining)
#   figures/fig5_event_study.pdf   (main event study figure)
# ============================================================================
