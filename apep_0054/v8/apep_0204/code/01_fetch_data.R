...
# INPUTS:
#   IPUMS CPS ASEC API (samples cps2015_03s through cps2025_03s)
#   Requires IPUMS_API_KEY environment variable
# OUTPUTS:
#   data/cps_asec_raw.rds  (raw IPUMS microdata, ~1M+ observations)
# ============================================================================
...
# We need CPS ASEC data from 2015-2025 (income years 2014-2024)
# This gives us 7+ pre-treatment years for early adopters (Colorado 2021)
# and adds NY and HI as treated states with post-treatment data (income year 2024)

cat("Defining IPUMS CPS ASEC extract...\n")

# Define the extract
extract <- define_extract_cps(
  description = "Salary Transparency Laws - CPS ASEC 2015-2025",
  samples = paste0("cps", 2015:2025, "_03s"),  # March ASEC supplements
  variables = c(
    # Identifiers
    "YEAR",           # Survey year
