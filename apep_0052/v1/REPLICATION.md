...
**Cached data files:**
- `acs_broadband_place.csv`
- `acs_broadband_place.parquet`
- `acs_demographics_2018.csv`
- `acs_demographics_2018.parquet`
- `analysis_panel.csv`
- `analysis_panel.parquet`
- `analysis_results.RData`
- `event_study_data.csv`
- `localview_annual.csv`
- `localview_annual.parquet`
- `panel_balance.csv`
- `summary_by_cohort.csv`
- `summary_by_year.csv`
