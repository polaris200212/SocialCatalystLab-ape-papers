...
# CHANGE: Extended from 2017-2023 to 2017-2024
##############################################################################
...
# Variable names differ between pre-2023 and 2023+ PUMS
# ST was renamed to STATE in 2023+ ACS PUMS
...
# Years to fetch (2017-2024 for 1-year ACS PUMS)
# CHANGE: Extended from 2017:2023 to 2017:2024
years <- 2017:2024
...
fetch_acs_pums <- function(year, vars) {
  ...
  # Harmonize STATE -> ST for 2023+ data
...
all_data <- list()
for (yr in years) {
  # Use appropriate variable names for each year
...
# Never-treated states (as of end of sample, 2024)
