...
# CHANGES: max_e extended to 3; new Section 6 with DDD design
##############################################################################
...
# CHANGE: Dynamic/event-study aggregation with max_e = 3 (was 2)
...
# CHANGE: control group now includes AR(5), WI(55), ID(16), IA(19)
sa_medicaid <- feols(
...
# =========================================================
# 6. NEW: Triple-Difference (DDD) Design
# =========================================================

cat("\n=== NEW: Triple-Difference (DDD) Design ===\n")
cat("Stacking postpartum + non-postpartum low-income women\n")
cat("DDD: medicaid ~ treated * postpartum_ind\n")
cat("This resolves the employer insurance placebo failure\n\n")
...
# Non-postpartum low-income (same age range, same income)
...
# --- 6b. DDD via fixest with state^postpartum and year^postpartum FE ---
ddd_medicaid <- feols(
...
# State-year panel: difference postpartum - non-postpartum Medicaid rates
